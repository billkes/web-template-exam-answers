<template>
	<view class="container">
		...
		<uni-card spacing="10px" margin="10px">
			<template v-slot:title>
				<view class="section-header">
					<uni-title type="h3" title="用户注册" align="left"></uni-title>
		...
		<uni-card spacing="10px" margin="10px">
			<template v-slot:title>
				<view class="section-header">
					<uni-title type="h3" title="用户登录" align="left"></uni-title>
		...
		<uni-card spacing="10px" margin="10px">
			<template v-slot:title>
				<view class="section-header">
					<uni-title type="h3" title="获取用户信息" align="left"></uni-title>
		...
		<uni-card spacing="10px" margin="10px">
			<template v-slot:title>
				<view class="section-header">
					<uni-title type="h3" title="操作结果" align="left"></uni-title>
